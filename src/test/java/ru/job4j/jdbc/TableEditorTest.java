 ...
 * }
 * @Test public void whenAddAndThenRenameColumn() throws Exception {
 ...
 * }
 * }
 * @Test public void whenAddAndThenDropColumn() throws Exception {
 * try (TableEditor editor = new TableEditor(properties)) {
 * editor.dropTable("testTable");
 * editor.createTable("testTable");
 * editor.addColumn("testTable", "id", "serial");
 ...
 * }
 * }
 * @Test public void whenAddAndThenDropTable() throws Exception {
 * try (TableEditor editor = new TableEditor(properties)) {
 * editor.dropTable("testTable");
 * editor.createTable("testTable");
 * editor.addColumn("testTable", "id", "serial");
